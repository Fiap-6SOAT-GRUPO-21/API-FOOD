package br.com.api_food.application.controller.manager;


import br.com.api_food.application.dtos.manager.ManagerDTO;
import br.com.api_food.application.dtos.manager.ManagerInputDTO;
...
public class ManagerController {
    ...
    @GetMapping("/cpf/{cpf}")
    public ResponseEntity<br.com.api_food.application.dtos.manager.ManagerDTO> findManagerByCpf(@PathVariable String cpf) {
        ManagerDomain managerDomain = findManager.execute(cpf);
        if (managerDomain != null) {
            br.com.api_food.application.dtos.manager.ManagerDTO managerDTO = modelMapper.map(managerDomain, ManagerDTO.class);
    ...
    @PostMapping
    public ResponseEntity<br.com.api_food.application.dtos.manager.ManagerDTO> saveNewManager(@RequestBody @Valid ManagerInputDTO managerInputDTO) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<br.com.api_food.application.dtos.manager.ManagerDTO> updateManager(@PathVariable UUID id, @RequestBody ManagerInputDTO managerInputDTO) {
        ManagerDomain domain = modelMapper.map(managerInputDTO, ManagerDomain.class);
        domain.setId(id);
